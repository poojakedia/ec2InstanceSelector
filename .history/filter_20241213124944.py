...
def storage_filtration(ebs, storage_reqs):
    ...
    return cur.fetchall()
def main():
    OS = input("Choose desired OS system, Linux or Windows")
    if(OS.lower() == "linux"):
        OStype = "Linux Reserved cost"
    elif (OS.lower() == "windows"):
        OStype = "Windows Reserved cost"
    else:
        print("Invalid input")
        return 
    comp_options ='''
